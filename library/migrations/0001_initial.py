    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shabak', models.CharField(max_length=120)),
                ('year', models.TimeField()),
                ('title', models.CharField(max_length=120)),
                ('number', models.IntegerField(default=1)),
                ('number_of_reserved', models.IntegerField(default=0)),
            ],
        ),
        migrations.CreateModel(
            name='LibraryAdmin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admiter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='library.LibraryAdmin')),
            ],
        ),
    ]
